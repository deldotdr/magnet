...
class Unit(AMQPService):
    ...
    def startService(self):
        ...
        InstanceAnnounceConsumer({'node_type':node_type}).setServiceParent(self)
    ...
    def startConfigApp(self):
        ...
        if config_app_script:
            ...
            ConfigAppResponseConsumer({'node_type':self.node_type}).setServiceParent(self)
    ...
    def startRunApp(self):
        ...
        if run_app_script:
            RunAppResponseConsumer({'node_type':self.node_type}).setServiceParent(self)
